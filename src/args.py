...
def set_parser():
    parser = argparse.ArgumentParser(
        prog="pytextimage",
        description="Generate custom images with text easily.")

    parser.add_argument("-v", "--version",
                        action="version",
                        version="pytextimage " + __version__)
    ...
    parser.add_argument("-T", "--text_size",
                        type=int,
                        dest="text_size",
                        help=HELP_INFO["text_size"])
    parser.add_argument("-l", "--line_spacing",
                        type=float,
                        dest="line_spacing",
    ...
    parser.add_argument("-p", "--padding",
                        type=float,
                        dest="padding",
                        help=HELP_INFO["padding"])
    parser.add_argument("-s", "--save",
                        type=str,
                        dest="save_path",
                        help=HELP_INFO["save_path"])
    return parser
